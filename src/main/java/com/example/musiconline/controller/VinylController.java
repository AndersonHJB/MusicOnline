...
public class VinylController {
     ...
     * 获取唱片列表
     */
    @Log(title = "获取唱片列表", businessType = BusinessType.OTHER)
    @PostMapping("/list")
     ...
     * 新增唱片
     */
    @Log(title = "新增唱片", businessType = BusinessType.INSERT)
    @PostMapping("/save")
     ...
     * 修改唱片
     */
    @Log(title = "修改唱片", businessType = BusinessType.UPDATE)
    @PostMapping("/update")
     ...
     * 删除唱片
     */
    @Log(title = "删除唱片", businessType = BusinessType.DELETE)
    @PostMapping("/delete")
     ...
     * 获取全部唱片
     */
    @Log(title = "获取全部唱片", businessType = BusinessType.OTHER)
    @PostMapping("/select")
    public TableDataInfo<VinylVo> getVinylSelect(@RequestBody VinylBo bo) {

        return service.getVinylSelect(bo);
    }
}
